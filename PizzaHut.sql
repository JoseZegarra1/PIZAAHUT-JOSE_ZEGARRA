...
CREATE TABLE VENTA (
    ...
    PRETOTVEN decimal(10,2)  NOT NULL,
    IDPER int  NOT NULL,
...
CREATE TABLE PROVEEDOR (
    ...
    RAZSOCPROV varchar(300)  NOT NULL,
    RUCPROV char(11)  NOT NULL,
    EMAPROV varchar(30)  NOT NULL,
    CELPROV char(9)  NOT NULL,
    DIRPROV varchar(100)  NOT NULL,
    TIPPROV varchar(30)  NOT NULL,
...
CREATE TABLE COMPRA (
    ...
    PRETOTCOM decimal(10,2)  NOT NULL,
...
-- foreign keys
-- Reference: CLIENTE_UBIGEO (table: PERSONA)
ALTER TABLE PERSONA ADD CONSTRAINT CLIENTE_UBIGEO
    FOREIGN KEY (CODUBI)
...
-- Ver estructura de la tabla PROVEEDOR
SELECT
	column_name,
	data_type
FROM
...
('Margaritas Nely S.A.C.','20035458745','margaritas.nely@gmail.com','923542788','Av Giron 28','FLOR','A','250401'),
('Fifty Flowers S.A.C.','20735458764','fyfty.flowers@gmail.com','956219873','Av Cesar Vallejo','ROSA','A','250401'),
('Wholesale Blossoms S.A.C.','25478631254','whoslesale.bloss@gmail.com','924349834','Ramos Larrea Giron 2','ROSA','A','250401'),
('Wholesale Flowers and Supplies S.A.C.','20473214598','whoslesale.flowers@gmail.com','946753791','Malvinas Calle 12','FLOR','A','250401'),
('United Wholesale Flowers S.A.C.','27542678315','unitedwf@gmail.com','946378124','Av Asuncion 8','ACCESORIO','A','250401'),
('Blooms By the Box S.A.C.','24752165934','bloomsthebox@gmail.com','976183761','Subida Carmen Alto','PELUCHE','A','250401'),
('Global Rose S.A.C.','20543567832','globalrose@gmail.com','976349615','Calle Pedro Ramirez','CHOCOLATE','A','250401'),
('Triangle Nursery S.A.C.','20753154947','trianglenursery@gmail.com','924342678','Av Ayacucho','PERFUME','A','250401'),
('Tesselaar Flowers S.A.C.','20427912348','tesselear.flowers@gmail.com','926437649','Av Manuel Giron 13','ACCESORIO','A','250401'),
('Denver Wholesale Flowers S.A.C.','20432197642','denverflowers@gmail.com','929127648','Av Cerro Alegre','ACCESORIO','A','250401'),
('JM Floristeria S.A.C.','20035458721','jflorr@gmail.com','923542720','Av.Sucre Union 17','FLOR','A','250401'),
('Flores Delivery S.A.C.','20735458722','fdeliv@gmail.com','956219821','Jr. 2 de Mayo','ROSA','A','250401'),
('Florería modelo S.A.C.','25478631223','fmodel@gmail.com','924349822','Ayacucho Cuadra 3','ROSA','A','250401'),
('Floreria Rosabel S.A.C.','20473214524','frosab@gmail.com','946753723','Calle Mar','FLOR','A','250401'),
('Floreria Flores y Detalles S.A.C.','27542678325','ffdetalles@gmail.com','946378724','Asociacion Esmeralda','ACCESORIO','A','250401'),
('Florerías Unidas S.A.C.','24752165926','funids@gmail.com','976183725','Calle Alvarez 58','PELUCHE','A','250401'),
('Kukyflor S.A.C.','20543567827','kukyflor@gmail.com','976349626','Zona Quijarte 47','CHOCOLATE','A','250401'),
('Florería San Borja S.A.C.','20753154928','fsanborja@gmail.com','924342627','Av Refineria 24','PERFUME','A','250401'),
('FLORERIA LOS HERRAJES S.A.C.','20427912329','fherrajs@gmail.com','926437628','Av Quispe Llanto','ACCESORIO','A','250401'),
('Floreria Rosaflor S.A.C.','20432197630','denverflowers@gmail.com','929127629','Candela Silvestre 47','ACCESORIO','A','250401');
...
('Pizza','HAWAIANA','20','¡El paraiso en la mesa! Se completa con jamon, jugosa pizza y queso mozzarella','15','A','1'),
('Pizza','CHICKEN BBQ','55','Exquisita combinacion de trozos de pollo, pizza, tocino y salsa BBQ','23','A','2'),
('Pizza','CLASICA','40','Pizza para compartir con tus 4 sabores favoritos Americana, Pepperoni, Hawaiana y Suprema','17','A','3'),
('Entradas','ALITAS','30','Pack de 9 Alitas','50','A','4'),
('Entradas','ROLLS DE JAMON & QUESO','50','6 Rolls de Jamon & queso rociados con queso parmesano y tostados','46','A','9'),
('Bebidas','INCA KOLA','25','*Para recojo en tienda se entregaran 4 vasos de gaseosa segun aplique','23','A','6'),
('Bebidas','COCA COLA','90','*Para recojo en tienda se entregaran 3 vasos de gaseosa segun aplique','5','A','7'),
('Bebidas','SPRITE','68','*Para recojo en tienda se entregara 1 vaso de gaseosa segun aplique','41','A','8'),
('Postres','TARTA DE MANZANA','14','Clasica tarta horneada elaborada a base de masa de hojaldre, rellena de compota de manzana y canela','37','A','9'),
('Postres','ROLLOS DE CANELA','30','6 Rollitos de canela rellenos de leche condensada para endulzar la temporada.','52','A','9'),
('Ofertas','LA 2° PIZZA MEDIANA ES GRATIS','20','2 Pizzas Medianas al precio de una','15','A','1'),
('Ofertas','DOBLE O NADA','55','1 Pizza Grande Americana, Pepperoni o Mix de Carnes','23','A','2'),
('Ofertas','LA FIJA','40','1 Pizza Grande Americana, Pepperoni o Mix de Carnes','17','A','3'),
('Combo','BANQUETE GRANDE','30','1 Pizza Grande, 8 Hut Bread de Queso, 1 Gaseosa de 1 L','50','A','4'),
('Combo','HUT PACK FAMILIAR','50','1 Pizza familiar, 8 Hut Breads de Queso, 4 Palitos a la Siciliana y, 1 Bebida 1L','46','A','9'),
('Combo','HUT COMBO MEDIANO','25','1 Pizza Mediana, 4 Palitos a la Siciliana, 1 Gaseosa Personal','23','A','6'),
('Pastas','DUO LASAGNA BOLOGNESA','90','1 Deliciosa Lasagna Bolognesa, 1 Gaseosa Peronal','5','A','7'),
('Pastas','LASAGNA BOLOGNESA','68','Deliciosa Lasagna horneada con Salsa Bolognesa y carnes.','41','A','8'),
('Entradas','PAN AL AJO (2 UN)','30','2 Panes al ajo','50','A','4'),
('Entradas','PIZZA ROLL FULL MEAT','50','Pizza Roll sabor Full Meat','46','A','9'),
('Bebidas','AGUA SAN LUIS SIN GAS PERSONAL','25','AGUA SAN LUIS SIN GAS PERSONAL','23','A','6');
...
('76919457','Jorge Alvarez','Vicente Rejas','931542287','Av Santa Rosa','jorge.vicente@gmail.com','A','C','0','150501'),
('76919458','Jonas Manuel','Zubieta Sulca','931542281','Av Guadalupe','jonas.zubieta@gmail.com','A','C','0','150501'),
('76919451','Naomi Enrique','Cama Elias','931542282','Av Ninos Hereos 3','naomi.cama@gmail.com','A','C','0','150501'),
('76919452','Jesus Javier','Canales Goycochea','931542283','Carretera Principe','jesus.canales@gmail.com','A','C','0','150501'),
('76919453','Luis Aaron','Lopez Aron','931542284','Plaza Construccion','luis.lopez@gmail.com','A','C','0','150501'),
('76919454','Luis Abel','Manzo Nunez','931542285','Av Miguel Hidalgo','luis.manzo@gmail.com','A','C','0','150501'),
('76919455','Jhonatan Adam','Maicelo Cuellar','931542286','San Salvador','jhonatan.maicelo@gmail.com','A','C','0','150501'),
('76919456','Ebert Adrian','Ocares Cruz','931542288','San Miguel','ebert.ocares@gmail.com','A','C','0','150501'),
('76919459','Giancarlo Agustin','Valencia Ocarez','931542289','Calle Adolfo Lopez','giancarlo.valencia@gmail.com','A','C','0','150501'),
('76919410','Fatima Alberto','Matos Sanchez','931542210','Centro Poblado','fatima.matos@gmail.com','A','C','0','150501'),
('76919421','Genaro Alejandro','Rejas Palomino','931542221','Av.Jiron Cuadra 12','grejas@gmail.com','A','C','0','150501'),
('76919422','Robhin Alfredo','Fenandez Alvino','931542222','Av.Ramos 2454','rfernandez@gmail.com','A','C','0','150501'),
('76919423','Julio Alonso','Contreras Ticte','931542223','Cuadra Pedro Suarez','jcontreras@gmail.com','A','C','0','150501'),
('76919424','Manuel Antonio','Quispe Goycochea','931542224','Jiron Ayacucho','mquispe@gmail.com','A','C','0','150501'),
('76919425','Oscar Bautista','Rejas Manzo','931542225','Oscar Ramos','oscarrejas@gmail.com','A','C','0','150501'),
('76919426','Michel Benjamin','Tito Amado','931542226','Ramos Larrea 45','mtito@gmail.com','A','C','0','150501'),
('76919427','Felipe Bruno','Cuellar Foden','931542227','Asuncion 85','fcuellar.maicelo@gmail.com','A','C','0','150501'),
('76919428','Felix Carlos','Ronaldo Silvestre','931542228','Malvinas 845','fronaldo@gmail.com','A','C','0','150501'),
('76919429','Santiago Elias','Sanchez Alcala','931542229','Nuevo canete Jiron 15','ssanchez@gmail.com','A','C','0','150501'),
('76919430','Doris Enzo','Quintero Rojas','931542230','Av. Cesar Vallejo','dquintero.com','A','C','0','150501'),
('76919440','Carlos Eric','Alvarez Meza','931542240','Giron Ayacucho','carlos@gmail.com','A','V','1250','240101'),
('76919442','Maria Ernesto','Cardenas Zegarra','931542241','Avenida Mariscal','Maria@gmail.com','A','V','1250','240102'),
('76919448','Marlon Ezequiel','Ayovi Vicente','931542242','Av Julio Caceres','marlon.ayovi@gmail.com','A','V','1250','240102');
...
INSERT INTO VENTA
(FECVEN,TIPVEN,METPAGVEN,PRETOTVEN,IDPER) VALUES
('01/05/2022','D','WP','25','1'),
('01/05/2022','D','TB','81','2'),
('01/05/2022','D','WP','64','3'),
('01/05/2022','D','ML','24','4'),
('01/05/2022','D','ML','74','5'),
('01/05/2022','L','EF','32','6'),
('01/05/2022','L','EF','49','7'),
('01/05/2022','L','EF','64','8'),
('01/05/2022','L','EF','11','9'),
('01/05/2022','L','EF','47','10'),
('01/05/2022','L','PS','60','11'),
('01/05/2022','L','PS','47','12'),
('01/05/2022','L','PS','28','13'),
('01/05/2022','L','EF','83','14'),
('01/05/2022','L','EF','67','15'),
('01/05/2022','D','ML','71','16'),
('01/05/2022','D','TB','12','17'),
('01/05/2022','D','TB','96','18'),
('01/05/2022','D','WP','17','19'),
('01/05/2022','D','ML','30','20');
GO
...
(CANVENDET,SUBVENDET,IDVEN,IDPRO) VALUES
('8','100','1','1'),
('14','11','2','2'),
('9','120','3','3'),
('17','20','4','4'),
...
-- Ver estructura de la tabla COMPRA
SELECT
	column_name,
	data_type
FROM
...
('01/05/2022','TB','79','A','9'),
('14/05/2022','TB','20','A','4'),
('15/05/2022','TB','20','A','1'),
('16/05/2022','TB','55','A','2'),
('18/05/2022','TB','4','A','3'),
('20/05/2022','PE','25','A','6'),
('06/06/2022','PE','80','A','7'),
('11/06/2022','PE','25','A','8'),
('11/06/2022','PE','25','A','10'),
('12/06/2022','PE','20','A','11'),
('24/06/2022','PE','25','A','12'),
('27/06/2022','PE','25','A','13'),
('28/06/2022','PE','25','A','14'),
('12/07/2022','PE','20','A','16'),
('12/07/2022','PE','20','A','18'),
('12/07/2022','PE','20','A','5');

-- Ver estructura de la tabla COMPRA_DETALLE
SELECT
	column_name,
	data_type
FROM
...
AS
    SELECT 
        ...
        ROW_NUMBER() OVER (ORDER BY C.IDPER DESC) AS ORDEN
    FROM 
        PERSONA AS C
...
AS
    SELECT 
		COM.IDCOM AS 'IDCOM',
        COM.FECCOM AS 'FECCOM',
		COM.METPAGCOM AS 'METPAGCOM',
        COM.PRETOTCOM AS 'PRETOTCOM',
        ROW_NUMBER() OVER (ORDER BY COM.IDCOM DESC) AS ORDEN
    FROM 
        COMPRA AS COM
GO
...
SELECT
	...
	P.IDPER AS IDPER,
    P.DNIPER AS DNIPER,
	UPPER(CONCAT(P.NOMPER,' ',P.APEPER)) AS NOMPER,
    V.FECVEN AS FECVEN,
...
-- Creación de Stores Procedurs

CREATE PROCEDURE spCompradetalle
	@codigoCompra int
AS
	SELECT 
		CD.IDCOM AS 'IDCOM',
...
CREATE PROCEDURE spVentadetalle
	@codigoVenta int
AS
	SELECT 
		VD.IDPRO AS 'IDPRO',
		VD.IDVENDET AS 'IDVENDET',
		CONCAT(PR.NOMPRO,' ',PR.TIPPRO) AS 'NOMPRO',
		VD.CANVENDET AS 'CANPRO',
		VD.SUBVENDET AS 'SUBVENDET'
	FROM
		VENTA_DETALLE AS VD
		INNER JOIN PRODUCTO AS PR
		ON VD.IDPRO = PR.IDPRO
	WHERE 
	VD.IDVEN = @codigoVenta;
	GO
...
SET  STOCKPRO = P.STOCKPRO - VD.CANVENDET
FROM PRODUCTO AS P,
